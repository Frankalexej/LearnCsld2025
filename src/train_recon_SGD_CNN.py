...
import tqdm
from model import SimpleResNet1DRecon
from torch.utils.data import DataLoader
from dataset import NPYDatasetRC_CNN as ThisDataset
import wandb
import numpy as np
import sys
...
def main(config_path, run_time=0):
    ...
    criterion = torch.nn.MSELoss(reduction="mean") # Using MSE for reconstruction. 
    # optimizer = optim.SGD(
    #     model.parameters(),
    #     lr=config.LR,
    #     momentum=0.0,
