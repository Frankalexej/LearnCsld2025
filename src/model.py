...
##################### Non-linear Simple Model #####################
"""
Notice that there is no difference bewteen NonLinearFC Recon and Class, just for compatibility of codes. 
"""
...
class NonLinearFCRecon(NonLinearFC):
