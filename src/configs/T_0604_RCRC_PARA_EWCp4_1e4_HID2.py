...
PRE_METHOD = "RC"
POST_METHOD = "RC"
L1_MANIPULANT_SELECT = ['s', 'c']  # L1: i u e o
L2_MANIPULANT_SELECT = ['tsh', 'tch']  # L2: i u ih uh
FREEZE_FOR_L2 = False            # whether to freeze the L1 encoder when training on L2
CONSOLIDATION_METHOD = "EWC"
CONSOLIDATION_STRENGTH = 10000.0   # trying stronger consolidation strength. p9 = 1e9. 
...
RUN_NAME = '0604_RCRC_PARA_EWCp4_1e4_HID2'
RUN_TIMES_START = 1
