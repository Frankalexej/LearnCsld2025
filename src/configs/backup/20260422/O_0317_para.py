...
RUN_TIMES_START = 1
RUN_TIMES_END = 11
RUN_NAMES = ['0317_RCRC_PARA_NFZ_1e4_HID2', '0317_RCRC_PARA_WEWC_1e3_HID2']  # '0317_RCRC_PARA_EWC_1e3_HID2', '0317_RCRC_PARA_NFZ_1e3_HID2', '0317_RCCL_PARA_EWC_1e3_HID2', '0317_RCCL_PARA_NFZ_1e3_HID2'
