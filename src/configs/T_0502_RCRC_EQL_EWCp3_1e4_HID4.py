...
L2_MANIPULANT_SELECT = ['i', 'u', 'ih', 'uh', 'e', 'o']  # L2: i u ih uh
FREEZE_FOR_L2 = False            # whether to freeze the L1 encoder when training on L2
CONSOLIDATION_METHOD = "EWC"
CONSOLIDATION_STRENGTH = 1000.0   # trying smaller consolidation strength. p3 = 1e3. 

# Seed control
BASE_SEED = 20260502          # shared across the entire project
DETERMINISTIC = False         # True only if you need strict determinism

SIMILARITY = "euclidean"
RUN_NAME = '0502_RCRC_EQL_EWCp3_1e4_HID4'
RUN_TIMES_START = 7
RUN_TIMES_END = RUN_TIMES_START+4
SAMPLE_LIST = []