...
RUN_TIMES_START = 1
RUN_TIMES_END = 11
RUN_NAMES = ['0421_RCRC_VERT_EWCp2_1e4_HID2']  # '0421_RCRC_PARA_EWCp0_1e3_HID2', '0421_RCRC_PARA_EWCp3_1e3_HID2', '0421_RCRC_VERT_EWCp0_1e3_HID2', '0421_RCRC_VERT_EWCp3_1e3_HID2'
