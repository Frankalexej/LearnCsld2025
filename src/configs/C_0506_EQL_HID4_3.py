...
L1_MANIPULANT_SELECT = ['e', 'o', 'i', 'u', 
                   'iL', 'uL', 'ihS', 'uhS', 
                   'iS', 'uS', 'ihL', 'uhL']  # L1: s vs c
L2_MANIPULANT_SELECT = ['e', 'o', 'i', 'u', 
                   'iL', 'uL', 'ihS', 'uhS', 
                   'iS', 'uS', 'ihL', 'uhL']  # L2: VERT still tsh vs sh. 
...
RUN_NAMES = ['0506_SCSC_EQL_EWCp0_1e4_HID4']
WRITE_RUN_NAMES = RUN_NAMES
RUN_TIMES_START = 1
RUN_TIMES_END = RUN_TIMES_START+2
