...
L1_MANIPULANT_LABEL = ['i', 'u', 'e', 'o']  # L1: s vs c
L2_MANIPULANT_LABEL = ['i', 'u', 'ih', 'uh', 'e', 'o']  # L2: VERT still tsh vs sh. 
...
RUN_NAMES = ['0502_RCCL_EQL_EWCp6_1e4_HID4']    # , '0502_RCCL_EQL_EWCp3_1e4_HID4'
