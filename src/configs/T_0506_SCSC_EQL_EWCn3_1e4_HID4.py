# 0506: use i/e as L1, ihL/iL/e as L2
...
L2_MANIPULANT_SELECT = ['iL', 'ihS', 'e']  # L2: i u ih uh
FREEZE_FOR_L2 = False            # whether to freeze the L1 encoder when training on L2
CONSOLIDATION_METHOD = "EWC"
CONSOLIDATION_STRENGTH = 1e-3   # trying stronger consolidation strength. p9 = 1e9. 

# Seed control
BASE_SEED = 20260506          # shared across the entire project
DETERMINISTIC = False         # True only if you need strict determinism

SIMILARITY = "euclidean"
RUN_NAME = '0506_SCSC_EQL_EWCn3_1e4_HID4'
RUN_TIMES_START = 1
