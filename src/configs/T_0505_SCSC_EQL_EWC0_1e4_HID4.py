# 0505: CNN, contrastive learning, with i/e for L1, iL/ihS for L2. 
...
L1_MANIPULANT_SELECT = ['i', 'e']  # L1: i u e o
L2_MANIPULANT_SELECT = ['iL', 'ihS']  # L2: i u ih uh
FREEZE_FOR_L2 = False            # whether to freeze the L1 encoder when training on L2
CONSOLIDATION_METHOD = "EWC"
CONSOLIDATION_STRENGTH = 0   # trying stronger consolidation strength. p9 = 1e9. 

# Seed control
BASE_SEED = 20260505          # shared across the entire project
DETERMINISTIC = False         # True only if you need strict determinism

SIMILARITY = "euclidean"
RUN_NAME = '0505_SCSC_EQL_EWC0_1e4_HID4'
RUN_TIMES_START = 1
RUN_TIMES_END = RUN_TIMES_START+5
SAMPLE_LIST = []

# NOTE: 0505 is for checking when there is no other salient contrasts, whether the learning will be more obvious. 